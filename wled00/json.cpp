...
void serializeDmxDiag(JsonObject root)
{
  ...
  // Highest channel this configuration would address. Anything past 512 does not fit
  // in a DMX universe, so the fixture count and/or the gap need reducing.
